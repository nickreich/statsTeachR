...
\item {\tt BiPSandbox/module2/permTest2.Rmd}.
\end{itemize}
...
{\tt BiPSandbox/module2/permTest2\_doMC.R}\\
{\tt BiPSandbox/module2/permTest2\_doParallel.R}\\
{\tt BiPSandbox/module2/permTest2\_mclapply.R}
\item Let's try to learn about different parallel computing speeds through an old-school distributed computing experiment: see {\tt BiPSandbox/module2/localParallelData.csv}
\end{itemize}

...
\bigskip
\item[] \underline{\sc Module 4}: \hfill 3:30PM  -- 4:45 PM

{\bf Topics in Big Data Sciences}
\begin{itemize}
\item \scriptsize Genome wide association data overview; Lab exercise applying workshop material
\end{itemize}
...
\item Basic statistical literacy, including characterization of uncertainty using sound statistical and computational principles (Modules 2, 3 \& 4).
\end{enumerate}
\end{frame}
...
\begin{block}{Demo... }
\begin{itemize}
        \item clone the BiPSandbox repository from GitHub
